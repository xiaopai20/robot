...
def train(tokenizer=None):
  # prepare dataset
  print("Preparing data in %s" % gConfig['working_directory'])
  enc_train, dec_train, enc_dev, dec_dev, enc_vocab_path, dec_vocab_path = data_utils.prepare_custom_data(gConfig['working_directory'],gConfig['train_enc'],gConfig['train_dec'],gConfig['test_enc'],gConfig['test_dec'],gConfig['enc_vocab_size'],gConfig['dec_vocab_size'], tokenizer)
...
#  with tf.Session(config=config) as sess:
  with tf.Session() as sess:
    ...
    _, enc_vocab = data_utils.initialize_vocabulary(enc_vocab_path)
